...
export const detailedServices: Record<string, DetailedServiceContent> = {
  'srv-1': {
    ...
    keywords: 'Web Development Company in Raipur, Software Development Company in Chhattisgarh, web developer Raipur, custom website Raipur, MERN stack Raipur, web design Raipur, IT company Chhattisgarh',
  ...
  'srv-2': {
    ...
    keywords: 'Mobile App Development Company in Raipur, Software Development Company in Chhattisgarh, Android app developer Raipur, iOS app developer Raipur, React Native Chhattisgarh, hybrid mobile apps Raipur',
  ...
  'srv-3': {
    ...
    keywords: 'AI Development Company in Raipur, Software Development Company in Chhattisgarh, machine learning Raipur, RAG chatbot Chhattisgarh, LLM integration Raipur, custom AI solutions India',
  ...
  'srv-4': {
    ...
    keywords: 'E-commerce Website Development in Raipur, Web Development Company in Raipur, e-commerce developer Raipur, online shop builder Chhattisgarh, Shopify headless Raipur, WooCommerce Raipur',
  ...
  'srv-5': {
    ...
    keywords: 'UI/UX Design Company in Raipur, Web Development Company in Raipur, UI UX designer Raipur, web designer Raipur Chhattisgarh, Figma prototype Raipur, mobile app interface design',
  ...
  'srv-6': {
    ...
    keywords: 'Branding & Logo Design Company in Raipur, Software Development Company in Chhattisgarh, logo designer Raipur, brand strategist Raipur, graphic design Chhattisgarh, business branding Raipur',
  ...
  'srv-7': {
    ...
    keywords: 'SEO Agency in Raipur, Web Development Company in Raipur, SEO Services Raipur Chhattisgarh, Search Engine Optimization Raipur, local SEO Chhattisgarh, search ranking Raipur',
  ...
  'srv-8': {
    ...
    keywords: 'Custom Software Development Company in Raipur, Software Development Company in Chhattisgarh, ERP software Raipur, custom CRM Chhattisgarh, IT consultant Raipur, SaaS development India',
