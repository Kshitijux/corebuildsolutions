              ...
              return (
                <Link
                  ...
                  className={`text-xs font-semibold tracking-wider uppercase px-4 py-2 rounded-lg transition-all duration-300 ${
                    isActive 
                      ? 'bg-blue-500/10 text-slate-950 dark:bg-slate-800 dark:text-white font-bold' 
                      : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-900/50 hover:text-slate-950 dark:hover:text-white'
                  }`}
                >
                  {link.label}
                </Link>
