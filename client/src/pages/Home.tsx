      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
            ...
            <header className="lg:col-span-7 flex flex-col gap-8 z-10 text-left">
              ...
              >
                As the leading <strong>web development company in raipur</strong>, <strong>CoreBuild Solutions</strong> engineers custom, sub-second web applications, mobile apps, e-commerce storefronts, and AI software systems for businesses across Raipur, Bhilai, Durg, Bilaspur, Korba, Raigarh, and all of Chhattisgarh. We focus on sub-second speed, custom database architectures, and measurable lead generation for every client build.
              </motion.p>
        ...
        <section className="py-20 px-6 lg:px-8 max-w-7xl mx-auto text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="p-6 bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-900 rounded-2xl flex flex-col gap-3">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                We construct frontends using React 19 and Vite, communicating with backend microservices via secure REST and GraphQL APIs. Decoupling logic protects database keys, eliminates template bloat, and guarantees long-term scalability.
              </p>
            </div>
          ...
          <div className="mt-12 p-8 md:p-10 bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col gap-4">
            ...
            <p className="text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
              Google ranks websites based on user experience metrics known as <strong>Core Web Vitals</strong>. As a technical <strong>web development company in raipur</strong>, CoreBuild Solutions engineers every web application to score 95+ on Google PageSpeed Insights:
            </p>
        ...
        <section className="py-20 px-6 lg:px-8 max-w-7xl mx-auto text-left border-t border-slate-200 dark:border-slate-900">
            ...
            {services.map((srv) => (
              <div key={srv.id} className="p-8 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-3xl flex flex-col justify-between hover:border-blue-500/30 transition-all">
                ...
                <Link to="/services" className="inline-flex items-center gap-1 text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider mt-6 hover:underline">
                  Explore Capability <ArrowUpRight size={12} />
                </Link>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 p-8 bg-blue-600 text-white rounded-3xl shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex flex-col gap-1">
              <h3 className="font-heading text-lg font-bold text-white">Looking for Custom Engineering Pricing?</h3>
              <p className="text-xs text-blue-100">Review our detailed service scope, pricing tiers, and delivery roadmaps for Chhattisgarh businesses.</p>
            </div>
        ...
        <section className="py-16 px-6 lg:px-8 max-w-7xl mx-auto text-left">
          <div className="p-8 md:p-12 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-3xl flex flex-col gap-6">
            ...
            <p className="text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
              Our <strong>web development company in raipur</strong> engineers scalable custom web applications, B2B SaaS management dashboards, multi-tenant administrative portals, and internal enterprise software. We design relational database schemas using PostgreSQL, MongoDB, and Redis caching to process complex data workflows without latency, ensuring enterprise data security and sub-second query response times.
            </p>
        ...
        <section className="py-16 px-6 lg:px-8 max-w-7xl mx-auto text-left">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-3xl flex flex-col gap-4">
              ...
              <Link to="/blog/react-vs-nextjs-frontend-framework-seo" className="text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider hover:underline mt-2">Read Framework Guide →</Link>
            </div>
        ...
        <section className="py-16 px-6 lg:px-8 max-w-7xl mx-auto text-left border-t border-slate-200 dark:border-slate-900">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-3xl flex flex-col gap-4">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                Our <strong>web development company in raipur</strong> delivers luxury Figma UI/UX designs featuring generous whitespace, Outfit typography, dark/light modes, and conversion-focused visual hierarchy.
              </p>
          ...
          <div className="mt-10 p-6 bg-slate-900 text-white rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="font-heading font-bold text-sm text-white">Need Guaranteed Post-Launch Maintenance?</h4>
              <p className="text-xs text-slate-400 mt-1">Every CoreBuild project includes 3 months of complimentary Hypercare support after launch.</p>
            </div>
          ...
          <div className="p-8 md:p-12 bg-gradient-to-r from-blue-900 to-slate-900 text-white rounded-3xl border border-blue-800 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col gap-4 max-w-xl">
              ...
              <p className="text-xs md:text-sm text-blue-200 leading-relaxed">
                Our <strong>web development company in raipur</strong> integrates custom LLM and RAG vector systems (Pinecone/pgvector), OpenAI/Claude APIs, and automated customer service chatbots directly into business web dashboards across Chhattisgarh.
              </p>
        ...
        <section className="py-20 px-6 lg:px-8 max-w-7xl mx-auto text-left border-t border-slate-200 dark:border-slate-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="p-6 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-2xl flex flex-col gap-2">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ERP inventory trackers, raw material dashboards, and supply chain software for industrial plants in Raipur.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-2xl flex flex-col gap-2">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                WebGL 3D property walkthroughs, Mapbox queries, and automated plot booking portals for developers.
              </p>
            </div>
